...
export const conditionEnum = pgEnum("condition", ["light_rehab", "medium_rehab", "heavy_rehab", "move_in_ready"]);
export const pipelineStageEnum = pgEnum("pipeline_stage", [
  "lead", "outreach", "scoring", "hot_routing", "warm_nurture",
  "cold_drip", "appointment", "close",
]);
export const callTypeEnum = pgEnum("call_type", ["initial", "follow_up", "appointment_confirmation", "voicemail"]);
...
export const dncReasonEnum = pgEnum("dnc_reason", ["seller_request", "national_registry", "litigant", "disconnected", "manual"]);
...
export const campaignMotivationFilterEnum = pgEnum("campaign_motivation_filter", ["all", "hot", "warm", "cold"]);
export const campaignStageFilterEnum = pgEnum("campaign_stage_filter", [
...
export const campaignLeadResultEnum = pgEnum("campaign_lead_result", [
...
export const webhookProviderEnum = pgEnum("webhook_provider", ["vapi", "bland", "retell", "custom"]);
...
export const campaigns = pgTable("campaigns", {
  ...
  motivationFilter: campaignMotivationFilterEnum("motivation_filter").default("all"),
  profileFilter: bigint("profile_filter", { mode: "number" }),
  stageFilter: campaignStageFilterEnum("stage_filter").default("all"),
...
export const campaignLeads = pgTable("campaign_leads", {
  ...
  callResult: campaignLeadResultEnum("call_result"),
