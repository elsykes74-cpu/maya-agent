...
import { sql, eq, and, or, gte, inArray, desc, isNull } from "drizzle-orm";
...
const MIGRATE_STATEMENTS: string[] = [
  ...
  // the app's direct Postgres (DATABASE_URL) and service_role paths
  // keep working unchanged. Fixed live 2026-09-15.
  ...
  `DROP POLICY IF EXISTS "service_role_all" ON "ai_config";`,
  `CREATE POLICY "service_role_all" ON "ai_config" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  ...
  `DROP POLICY IF EXISTS "service_role_all" ON "buyer_criteria";`,
  `CREATE POLICY "service_role_all" ON "buyer_criteria" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  ...
  `DROP POLICY IF EXISTS "service_role_all" ON "call_queue";`,
  `CREATE POLICY "service_role_all" ON "call_queue" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "calling_config" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "calling_config";`,
  `CREATE POLICY "service_role_all" ON "calling_config" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  ...
  `DROP POLICY IF EXISTS "service_role_all" ON "campaign_leads";`,
  `CREATE POLICY "service_role_all" ON "campaign_leads" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  ...
  `DROP POLICY IF EXISTS "service_role_all" ON "compliance_logs";`,
  `CREATE POLICY "service_role_all" ON "compliance_logs" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "dnc_list" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "dnc_list";`,
  `CREATE POLICY "service_role_all" ON "dnc_list" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "duplicate_flags" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "duplicate_flags";`,
  `CREATE POLICY "service_role_all" ON "duplicate_flags" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "follow_up_enrollments" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "follow_up_enrollments";`,
  `CREATE POLICY "service_role_all" ON "follow_up_enrollments" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "follow_up_messages" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "follow_up_messages";`,
  `CREATE POLICY "service_role_all" ON "follow_up_messages" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "follow_up_sequences" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "follow_up_sequences";`,
  `CREATE POLICY "service_role_all" ON "follow_up_sequences" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "lead_attributions" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "lead_attributions";`,
  `CREATE POLICY "service_role_all" ON "lead_attributions" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "lead_profiles" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "lead_profiles";`,
  `CREATE POLICY "service_role_all" ON "lead_profiles" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "lead_sources" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "lead_sources";`,
  `CREATE POLICY "service_role_all" ON "lead_sources" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  ...
  `ALTER TABLE "numverify_usage" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "numverify_usage";`,
  `CREATE POLICY "service_role_all" ON "numverify_usage" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "objection_responses" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "objection_responses";`,
  `CREATE POLICY "service_role_all" ON "objection_responses" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  ...
  `ALTER TABLE "phone_validation" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "phone_validation";`,
  `CREATE POLICY "service_role_all" ON "phone_validation" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "property_analyses" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "property_analyses";`,
  `CREATE POLICY "service_role_all" ON "property_analyses" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "rentcast_usage" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "rentcast_usage";`,
  `CREATE POLICY "service_role_all" ON "rentcast_usage" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "scrape_runs" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "scrape_runs";`,
  `CREATE POLICY "service_role_all" ON "scrape_runs" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "scrub_list_entries" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "scrub_list_entries";`,
  `CREATE POLICY "service_role_all" ON "scrub_list_entries" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "scrub_lists" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "scrub_lists";`,
  `CREATE POLICY "service_role_all" ON "scrub_lists" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "sms_logs" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "sms_logs";`,
  `CREATE POLICY "service_role_all" ON "sms_logs" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  `ALTER TABLE "sms_templates" ENABLE ROW LEVEL SECURITY;`,
  `DROP POLICY IF EXISTS "service_role_all" ON "sms_templates";`,
  `CREATE POLICY "service_role_all" ON "sms_templates" FOR ALL TO service_role USING (true) WITH CHECK (true);`,
  ...
  `ALTER TABLE IF EXISTS "maya_conversations" ENABLE ROW LEVEL SECURITY;`,
  `DO $$ BEGIN IF to_regclass('public.maya_conversations') IS NOT NULL THEN DROP POLICY IF EXISTS "service_role_all" ON "maya_conversations"; CREATE POLICY "service_role_all" ON "maya_conversations" FOR ALL TO service_role USING (true) WITH CHECK (true); END IF; END $$`,
];
